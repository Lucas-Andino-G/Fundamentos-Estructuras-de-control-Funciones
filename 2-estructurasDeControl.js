...
function repetirMensaje() {
    ...
    do {
        respuesta = confirm();
        //mientras la respuesta sea true, el bucle no se rompera, caso contrario se sale del bucle
    } while (respuesta){
        //Mientras que i sea menor a 5
        while (i < 5){
            //Se va a sumar 1 a i e imprimo un mensaje de texto
            i++
